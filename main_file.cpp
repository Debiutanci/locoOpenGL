...
void drawScene(GLFWwindow* window, float angle, float wheelAngle) {
	...
	glm::mat4 kratkie = glm::translate(glm::mat4(1.0f), glm::vec3(5.5f, 1.2f, 0.0f));
	glUniformMatrix4fv(spLambert->u("M"), 1, false, glm::value_ptr(kratkie));
	Models::komin1.drawSolid(spLambert, "./model/kolo1.obj");
